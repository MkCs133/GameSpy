...
namespace GameSpy.Migrations
{
    ...
    [Migration("20240325210653_propImageInGmaes")]
    partial class propImageInGmaes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GamePc", b =>
                {
                    b.Property<int>("GamesGameid")
                        .HasColumnType("int");

                    b.Property<int>("PcsPcid")
                        .HasColumnType("int");

                    b.HasKey("GamesGameid", "PcsPcid");
            ...
            modelBuilder.Entity("GameSpy.Models.PcsGames", b =>
                {
                    ...
                    b.HasKey("Pcsid", "Gamesid")
                        .HasName("PK_PCS_GAMES");

                    b.HasIndex("Gamesid")
                        .HasDatabaseName("PC_GAMES_FK");

                    b.HasIndex("Pcsid")
                        .HasDatabaseName("PC_GAMES2_FK");

                    b.ToTable("PC_GAMES", (string)null);
                });
