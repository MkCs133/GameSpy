...
namespace GameSpy.Migrations
{
    ...
    [Migration("20240313091658_GamesManyToMany")]
            ...
            modelBuilder.Entity("PcGame", b =>
                {
                    ...
                    b.HasKey("Gamesid", "Pcid");

                    b.HasIndex(new[] { "Pcid" }, "PC_GAMES2_FK");

                    b.HasIndex(new[] { "Gamesid" }, "PC_GAMES_FK");

                    b.ToTable("PCS_GAMES", (string)null);
                });
            ...
            modelBuilder.Entity("UserGame", b =>
                {
                    ...
                    b.HasIndex(new[] { "Userid" }, "USER_GAMES2_FK");

                    b.HasIndex(new[] { "Gamesid" }, "USER_GAMES_FK");
            ...
            modelBuilder.Entity("GameSpy.Models.Pc", b =>
                {
                    ...
                    b.HasOne("GameSpy.Models.AppUser", "User")
                        .WithMany("Pcs")
            ...
            modelBuilder.Entity("PcGame", b =>
                {
                    b.HasOne("GameSpy.Models.Game", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("FK_PC_GAM_PC_GAM_GAME");

                    b.HasOne("GameSpy.Models.Pc", null)
                        .WithMany()
                        .HasForeignKey("Pcid")
                        .IsRequired()
                        .HasConstraintName("FK_PC_GAM_PC_GAME_PC");
                });
            ...
            modelBuilder.Entity("UserGame", b =>
                {
                    b.HasOne("GameSpy.Models.Game", null)
                        ...
                        .HasForeignKey("Gamesid")
                        .IsRequired()
                        .HasConstraintName("FK_USER_GAM_USER_GAM_GAME");

                    b.HasOne("GameSpy.Models.AppUser", null)
                        .WithMany()
                        .HasForeignKey("Userid")
                        .IsRequired()
                        .HasConstraintName("FK_USER_GAM_USER_GAME_USER");
                });
